...
public class modifyData extends javax.swing.JFrame {
    ...
    public String nom_pers_supp;
    public String prenom_pers_supp;
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        //Si on appuie sur ce bouton, on retourne au menu principal
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            //On récupère les éléments dans les jTextField
            nom_pers_supp = jTextField1.getText();
            prenom_pers_supp = jTextField2.getText();
            //On créer une MAJ pour la BDD
            Maj maMaj = new Maj();
            //On supprime la personne concernée
            maMaj.supprimerPersonne(nom_pers_supp, prenom_pers_supp);
